...
iter <- subs %in% PBC$sample[PBC$sample$Processing_Cohort=='4.0','ind_cov']
set.seed(1)
treatment <- NULL
...
saveRDS(pvals,paste0(path,'/pvals_ruvdg_tr_imbalance_pop_Eint.rds'))

saveRDS(sw2its,paste0(path,'/asw2_ruvdg_tr_imbalance_pop_Eint.rds'))
saveRDS(swpits,paste0(path,'/aswp_ruvdg_tr_imbalance_pop_Eint.rds'))
