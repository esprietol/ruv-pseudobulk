...
saveRDS(pvals,paste0(path,'/pvals_ruvdg_tr_imbalance_pop_E.rds'))

saveRDS(sw2its,paste0(path,'/asw2_ruvdg_tr_imbalance_pop_E.rds'))
saveRDS(swpits,paste0(path,'/aswp_ruvdg_tr_imbalance_pop_E.rds'))
